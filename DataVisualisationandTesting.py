...
temp = [-0.46, 0.46]
diff = temp[1] - temp[0]
testArray=[(-0.46+round(e * (diff/10), 3)) for e in range(1, (10 + 1))]
testArray2=[round(e * (1.2/10), 3) for e in range(1, (10 + 1))]

print(np.digitize([-0.46, 0.46], [10, 10, 10], right=True))
print(testArray)
print(testArray2)
print([-0.46+e for e in testArray])
